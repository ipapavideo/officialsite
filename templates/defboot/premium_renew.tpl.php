<?php defined('_VALID') or die('Restricted Access!'); $this->_js[] = '_user_signup.js'; ?>
	  <div id="content">
		...
		<div class="left">
		  <form id="register-form" class="form-horizontal" role="form" method="post" action="<?php echo REL_URL.LANG; ?>/premium/renew/">
            ...
            <div class="col-sm-offset-2 col-center">
          	  <button type="submit" name="submit_renew" id="submit-renew" class="btn btn-submit"><?php echo __('renew'); ?></button>
            </div>
		  </form>
		</div>
