...
function ajax_plugin_chat_friend()
{
    ...
    if ($action == 'add') {
        ...
        if (VCfg::get('user.activity')) {
  		...
  		$data['code']		= '<button id="friend-del" class="btn btn-xs btn-submit btn-friend" data-action="del" data-id="'.$friend_id.'"><i class="fa fa-user-times"></i> '.__('unfriend').'</button>';
        ...
        if (VCfg::get('user.activity')) {
  		...
  		$data['code']   	= '<button id="friend-add" class="btn btn-xs btn-submit btn-friend" data-action="add" data-id="'.$friend_id.'"><i class="fa fa-user-plus"></i> '.__('add-friend').'</button>';
