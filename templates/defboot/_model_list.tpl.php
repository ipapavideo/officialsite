...
<ul class="models<?php if (isset($this->mclass)): echo ' ',$this->mclass; endif; ?>">
  <?php foreach ($this->models as $model): $arrow = 'up'; $color = 'text-success'; if ($model['rank_prev'] > $model['rank']): $arrow = 'down'; $color = 'text-danger'; endif; ?>
  <li id="model-<?php echo $model['model_id']; ?>" class="model">
    <a href="<?php echo model_url($model['slug']); ?>" title="<?php echo e($model['name']); ?>" class="image">
  	  <div class="model-thumb">
  		<img src="<?php echo MODEL_URL,'/',$model['model_id'],'.',$model['ext']; ?>" alt="<?php echo __('model-avatar', e($model['name'])); ?>">
