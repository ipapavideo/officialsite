<?php defined('_VALID') or die('Restricted Access!'); $this->_js[] = '_photo_view.js'; ?>
	  <div id="photo" data-id="<?php echo $this->photo['photo_id']; ?>" data-album="<?php echo $this->photo['album_id']; ?>" data-user="<?php echo $this->user_id; ?>">
		...
		<div class="left">
		  ...
		  <div id="image">
			<?php if ($this->friends): ?>
			<a href="<?php echo REL_URL,LANG,'/photo/',$this->photo_next; ?>/"><img src="<?php echo $this->photo['photo_url'],'/',$this->photo_id,'.',$this->photo['ext']; ?>" alt="<?php echo $this->photo['caption']; ?>" class="img-fluid" style="max-width: 100%;"></a>
