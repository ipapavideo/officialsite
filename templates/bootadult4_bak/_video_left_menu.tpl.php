...
<?php endif; if (VCfg::get('video.browse_order') and isset($this->orders)): ?>
<hr width="90%">
<div class="list-group list-group-small">
  <?php $icons = VData::get('orders_icons', 'video'); foreach ($this->orders as $order => $name): $active = ($order == $this->order) ? ' active'  : ''; ?>
...
<?php endif; if (VCfg::get('video.browse_category')): ?>
<hr width="90%">
