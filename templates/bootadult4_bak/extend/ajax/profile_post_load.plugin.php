...
function ajax_plugin_profile_post_load()
{
    ...
    $code[]	= '<div class="col-6"><small><span id="profile-remaining" class="text-muted">10000</span> '.__('characters-left').'</small></div>';
    $code[]	= '<div class="col-6 text-right"><button id="wall-submit" class="btn btn-sm btn-primary rounded-pill">'.__('post').'</button></div>';
    $code[]	= '</div>';
