...
$(document).ready(function() {
  $('input[name="tags"]').tagsInput({minChars:2, height:'70px',width:'100%',defaultText:'<?php echo __('add-a-tag'); ?>', placeholderColor:'#999999'});  	  
  ...
  $("img[id^='photo-']").click(function() {
	...
	$("img[id^='photo']").removeClass('border-primary rounded-pill');
	$(this).addClass('border-primary rounded-pill');
  });    	
});
</script>