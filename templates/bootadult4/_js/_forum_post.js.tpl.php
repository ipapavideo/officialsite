...
<?php endif; ?>
<link type="text/css" rel="stylesheet" href="<?php echo REL_URL; ?>/misc/sceditor2/minified/themes/default.min.css" />
<script src="<?php echo REL_URL; ?>/misc/sceditor2/minified/jquery.sceditor.bbcode.min.js"></script>
<script src="<?php echo REL_URL; ?>/misc/sceditor2/languages/<?php echo $language; ?>.js"></script>
<script>
