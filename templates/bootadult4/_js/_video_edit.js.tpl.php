...
<link rel="stylesheet" href="<?php echo REL_URL; ?>/misc/select2-bootstrap4/css/select2-bootstrap4.min.css">
...
$(document).ready(function() {
  ...
  $('img.video-image').on('click', function() {$("input[name='thumb']").val($(this).data('nr')); $('.video-image').removeClass('border-primary'); $(this).addClass('border-primary');});
});
</script>
