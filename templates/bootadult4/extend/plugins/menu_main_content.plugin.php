...
function template_plugin_menu_main_content($current)
{
	...
	foreach ($links as $index => $link) {
		...
		if ($link['current'] == 'video') {
            ...
            $menu[] 	= '<div class="h3 w-100">Popular Videos</div>';
            ...
            $menu[] 	= '<div class="h3 w-100">Popular Albums</div>';
            ...
            $menu[] 	= '<div class="h3 w-100">Popular Categories</div>';
            ...
            $menu[] 	= '<div class="h3 w-100">Popular Channels</div>';
            ...
            $menu[] 	= '<div class="h3 w-100">Popular Users</div>';
