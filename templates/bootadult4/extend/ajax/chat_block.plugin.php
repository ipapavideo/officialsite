...
function ajax_plugin_chat_block()
{
    ...
    if ($action == 'add') {
  		...
  		$data['code']		= '<button id="block-del" class="btn btn-xs btn-primary btn-block" data-action="del" data-id="'.$blocked_id.'"><i class="fa fa-minus"></i> '.__('unblock').'</button>';
  		...
  		$data['code']   	= '<button id="block-add" class="btn btn-xs btn-primary btn-block" data-action="add" data-id="'.$blocked_id.'"><i class="fa fa-plus"></i> '.__('block').'</button>';
