...
<div class="w-100 p-1 mb-1 border bg-section rounded-lg">
  ...
  <div class="d-flex">
	<a href="<?php echo $link; ?>" rel="nofollow">
	  <img src="<?php echo $img; ?>" alt="<?php echo $alt; ?>" width="50" class="rounded">
	</a>
	<div class="ml-2">
	  <div class="d-flex align-items-top">
		<h5 class="mb-0"><a href="<?php echo $link; ?>" rel="nofollow"><?php echo $name; ?></a></h5>
	  ...
	  <small class="text-muted w-100"><i class="fa fa-clock-o"></i> <?php echo VDate::nice($activity['add_time']); ?></small>
	  <?php $class = $trans; if (!$is_post): $class = substr($trans, 0, strpos($trans, '-')); endif; ?>
	</div>
  </div>
  <div class="stream-content w-100">
