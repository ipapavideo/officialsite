<?php defined('_VALID') or die('Restricted Access!'); $icons = VData::get('orders_icons', 'photo'); if (VCfg::get('photo.browse_timeline')): $timelines = array('viewed', 'rated'); if (in_array($this->order, $timelines)): $timeline_display = true; endif; endif; ?>
