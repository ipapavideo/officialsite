<?php defined('_VALID') or die('Restricted Access!'); $this->_js[] = '_photo_album_upload.js'; ?>
	  <div id="content">
		<h1><?php echo e($this->title); ?> <a href="<?php echo REL_URL; ?>/upload/" class="btn btn-xs btn-submit pull-right"><?php echo __('upload-videos'); ?></a></h1>
		<div class="right">
		  <h3><?php echo e(__('photo-upload-rules')); ?></h3>
		  <ul class="nav nav-stacked">
            <?php $extensions = explode(',', VCfg::get('photo.allowed_extensions')); ?>
            <li><i class="fa fa-check-square"></i> <?php echo __('photo-rule-1', VCfg::get('photo.max_size')); ?></li>
            <li><i class="fa fa-check-square"></i> <?php echo __('photo-rule-2', implode(', ', $extensions)); ?></li>
            <li><i class="fa fa-check-square"></i> <?php echo __('photo-rule-3', VCfg::get('photo.max_categories')); ?></li>
            ...
            <div id="models-group" class="form-group">
              ...
              <div class="col-sm-10">
            	<select name="models[]" id="models" class="form-control" multiple="multiple">
                  <?php if ($this->album['models']): foreach ($this->album['models'] as $model_id => $name): ?>
            ...
            <div id="categories-group" class="form-group">
              ...
              <div class="col-sm-10 col-md-4 col-lg-3">
            	<select name="channel_id" id="channel_id" class="form-control select2">
            	  ...
            	  <?php foreach ($this->channels as $channel): echo VForm::option(e($channel['name']), $channel['channel_id'], $this->album['channel_id']); endforeach; ?>
                </select>
