<?php defined('_VALID') or die('Restricted Access!'); $this->_js[] = '_forum_post.js'; ?>
	  <div id="content">
		...
		<div class="left left-full">
		  <form id="topic-form" role="form" method="post" action="<?php echo REL_URL,LANG,'/forum/edit/',$this->topic_id; ?>/">
            ...
            <div id="content-group" class="form-group">
          	  <textarea name="content" id="post-content"><?php echo $this->topic['content_bbcode']; ?></textarea>
            </div>
            <div class="pull-left">
