...
<script>var base_url='<?php echo BASE_URL; ?>', cur_url='<?php echo CUR_URL; ?>', mobile_url='<?php echo MOBILE_URL; ?>', ajax_url='<?php echo MOBILE_URL; ?>', rel_url='<?php echo REL_URL; ?>', tmb_url='<?php echo THUMB_URL; ?>', age_check=<?php echo VCfg::get('age_check'); ?>;</script>
...
<?php endif; if (isset($this->_js) && $this->_js): foreach ($this->_js as $tpl): echo $this->fetch('_js/'.$tpl, true); endforeach; endif; ?>
<?php if ($js = VCfg::get('template.mobile.javascript_code_footer')): echo $js; endif; ?>
