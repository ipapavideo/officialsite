<?php defined('_VALID') or die('Restricted Access!'); $this->_js[] = '_video_view_videojs6.js'; $this->vast = p('adv_vast'); $this->preroll = false; if (!$this->vast): $this->preroll = p('adv_preroll'); endif; ?>
<?php if ($minify = VCfg::get('player.videojs.minify')): ?>
<link rel="stylesheet" href="<?php echo REL_URL; ?>/misc/videojs6-all/video.min.css?t=<?php echo $minify; ?>">
<?php if ($this->vast): ?>
<link rel="stylesheet" href="<?php echo REL_URL; ?>/misc/videojs-ima/videojs.ima.css">
<?php endif; else: ?>
<link rel="stylesheet" href="<?php echo REL_URL; ?>/misc/videojs6/video-js.min.css">
<link rel="stylesheet" href="<?php echo REL_URL; ?>/misc/videojs6-skin/videojs.skin.css">
