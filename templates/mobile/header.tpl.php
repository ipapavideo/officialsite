...
<?php endif; endif; if (isset($this->prev_url)): ?><link rel="prev" href="<?php echo $this->prev_url; ?>"><?php endif; ?>
  ...
  <?php if ($minify = VCfg::get('template.mobile.minify')): ?>
  ...
  <link href="<?php echo TPL_REL; ?>/css/theme-<?php echo VCfg::get('template.mobile.colors'); ?>.css"  rel="stylesheet">  
  ...
  <?php if ($js = VCfg::get('template.mobile.javascript_code')): echo $js; endif; ?>
  <!--[if lt IE 9]>
...
<div class="wrapper">
  ...
  <div class="full top">
	<div class="container">
	  ...
	  <div class="logo"><a href="<?php echo REL_URL.LANG; ?>/" title="<?php echo VCfg::get('site_name'); ?>"><img src="<?php if ($logo_url = VCfg::get('template.mobile.logo_url')): echo $logo_url; else: echo TPL_REL,'/images/logo.png?t='.VCfg::get('template.mobile.logo_time'); endif; ?>" alt="<?php echo VCfg::get('site_name'); ?>"></a></div>
	  <div class="search">
